  ...
  import { Container, Card, Divider, Image, Grid, Button, Icon, Header, Input } from 'semantic-ui-react';
                                ...
                                <Grid>
                                  <Grid.Row columns="equal">
                                    <Grid.Column>
                                      ...
                                      <p>{this.props.userSector.name}</p>
                                    </Grid.Column>
                                    ...
                                    <Grid.Column>
                                      ...
                                      <p>{this.props.userSector.name}</p>
                                      <p>{this.props.userSector.phoneNumber}</p>
                                      <p>{this.props.userSector.email}</p>
                                    </Grid.Column>
                                  </Grid.Row>
                                </Grid>
                              </Card.Content>
